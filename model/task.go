...
type TaskBillingContext struct {
	...
	ChannelCostRate            float64            `json:"channel_cost_rate,omitempty"`
	ChannelCostRateSet         bool               `json:"channel_cost_rate_set,omitempty"`
	ChannelCostRateVersionId   int64              `json:"channel_cost_rate_version_id,omitempty"`
	ChannelCostRateEffectiveAt int64              `json:"channel_cost_rate_effective_at,omitempty"`
