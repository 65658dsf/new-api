...
func NewBillingSession(c *gin.Context, relayInfo *relaycommon.RelayInfo, preConsumedQuota int) (*BillingSession, *types.NewAPIError) {
	...
	case "subscription_only":
		hasSub, subCheckErr := model.HasActiveUserSubscriptionForGroup(relayInfo.UserId, billingGroup)
		if subCheckErr != nil {
	...
	default:
		...
		if apiErr != nil {
			if apiErr.GetErrorCode() == types.ErrorCodeInsufficientUserQuota {
				...
				allowOverflow, overflowErr := model.UserActiveSubscriptionsAllowWalletOverflowForGroup(relayInfo.UserId, billingGroup)
				if overflowErr != nil {
