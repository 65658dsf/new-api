...
export const STATIC_I18N_KEYS = [
  ...
  'Operation Log',
  'All Payment Methods',
  'Search by order number, user or email...',
  'Successful orders completed today',
  'Successful orders in the selected range',
  'Orders completed today',
  'Average successful order amount',
  'Daily successful order income and order count',
  'Successful orders grouped by method',
  'Users ranked by successful payment volume',
  'Orders completed on each day in the selected range',
  'View payment order details and status timeline',
  'Complete the selected pending order?',
  ...
  'Daily revenue, cost, and profit in the selected range',
  'Compare revenue, cost, profit, and coverage',
  'Net user charges in the selected range',
  'Model base cost multiplied by channel rate',
  'Revenue minus channel cost',
  'Profit Margin',
  ...
  'Select a valid date range of no more than 90 days.',
