	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.GET("/invoices/orders", controller.GetUserInvoiceTopUpRecords)
				selfRoute.GET("/invoices", controller.GetUserInvoiceApplications)
				selfRoute.POST("/invoices", middleware.CriticalRateLimit(), controller.SubmitInvoiceApplication)
				selfRoute.DELETE("/invoices/:id", middleware.CriticalRateLimit(), controller.CancelUserInvoiceApplication)
				selfRoute.GET("/invoices/:id/download", controller.DownloadUserInvoicePDF)
			...
			adminRoute.Use(middleware.AdminAuth())
			{
				...
				adminRoute.GET("/topup/overview", controller.GetTopUpOverview)
				adminRoute.GET("/topup", controller.GetAllTopUps)
				adminRoute.POST("/topup/complete", controller.AdminCompleteTopUp)
				adminRoute.DELETE("/topup/:id", controller.AdminDeleteTopUp)
		...
		subscriptionAdminRoute.Use(middleware.AdminAuth())
		{
			...
			subscriptionAdminRoute.GET("/subscriptions", controller.AdminListSubscriptions)
			...
			subscriptionAdminRoute.POST("/user_subscriptions/:id/reset", controller.AdminResetUserSubscription)
			subscriptionAdminRoute.PATCH("/user_subscriptions/:id", controller.AdminUpdateUserSubscription)
		...
		dataRoute.GET("/financial", middleware.AdminAuth(), controller.GetFinancialReport)
